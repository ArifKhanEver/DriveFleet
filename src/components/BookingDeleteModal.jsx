...
export function BookingDeleteModal({ booking }) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            toast.success('Booked car deleted successfully')
            router.refresh();
                        ...
                        <Modal.Dialog className="bg-white rounded-2xl p-6 max-w-md mx-auto shadow-xl border border-slate-100 flex flex-col items-center text-center">
                            ...
                            <Modal.Body className="mt-2">
                                <p className="text-sm text-slate-500 font-semibold leading-relaxed">
                                    Are you sure you want to delete this booking? This action cannot be undone and your reservation will be permanently lost.
                                </p>
                            </Modal.Body>
